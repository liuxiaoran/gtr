...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    private static String APPKEY = "5d2463303eb0";
    // 填写从短信SDK应用后台注册得到的APPSECRET
    private static String APPSECRET = "bef3f4eb097a6cecf0fc92016842ce16";
    String pw;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        register_tv.setText(
                Html.fromHtml(
                        "点击注册表示同意" +
                                "<a href=\"http://www.google.com\">《gtr软件许可及服务协议》</a> "));
